        ...
        for entry in data["entry"]:
            for messaging_event in entry["messaging"]:
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    send_message(sender_id, "Cảm ơn bạn đã gửi tin nhắn!")
                    send_quick_reply(sender_id, "Pick a color:")
                ...
                if messaging_event.get("postback"):  # user clicked/tapped "postback" button in earlier message
                    ...
                    recipient_id = messaging_event["recipient"]["id"]  # the recipient's ID, which should be your page's facebook ID
                    message_text = messaging_event["message"]["text"]  # the message's text
                    send_message(sender_id, "Chào bạn. Cảm ơn bạn đã quan tâm đến chúng tôi!")
...
def get_started():
    ...
    r = requests.post("https://graph.facebook.com/v4.0/me/messenger_profile", params=params, headers=headers, data=data)
